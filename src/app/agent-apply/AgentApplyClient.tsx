...
export default function AgentApplyClient() {
  ...
  const handleSubmit = async (e: any) => {
    ...
    // TRIGGER PRINT DIALOG FIRST - User receives legal receipt
    window.print();
    ...
    <div className="min-h-screen bg-[#09090b] text-gray-300 p-4 font-sans pb-20 print:block print:h-auto print:min-h-0 print:overflow-visible print:bg-white print:text-black print:p-8">
      <div className="max-w-md mx-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-7">
          {/* SEC 1: AGENT DOSSIER - Personal Info */}
          <div className="print:hidden">
            ...
            <div className={`grid grid-cols-2 gap-0 ${borderStyle}`}>
              ...
              <input 
                ...
                className={`${rapidInputStyle} border-r col-span-1 text-gray-400`} 
          ...
          {/* SEC 2: TERRITORY & OPERATIONAL CAPACITY */}
          <div className="print:hidden">
            ...
            <div className={`${borderStyle} p-4 space-y-4`}>
              ...
              <div>
                ...
                <input 
                  name="employment" 
                  required
                  placeholder="e.g., Sari-sari store owner, Tricycle driver" 
                  className="w-full bg-black border border-zinc-800 rounded p-2 text-white text-sm" 
          ...
          {/* SEC 3: FORENSIC VERIFICATION (Uploads) */}
          <div className="print:hidden">
          ...
          {/* SEC 4: COMMISSION AGREEMENT & LEGAL CONSENT */}
          <div className="print:hidden">
              ...
              <div className="border border-zinc-700 p-4 text-sm text-zinc-300 print:break-inside-avoid print:mb-4 print:bg-white print:border-black print:text-black">
                ...
                <ol className="list-decimal pl-5 space-y-2">
                  <li className="break-words print:text-black">
                    <strong>Hatian ng Komisyon (40/60 Rule):</strong> Ang Ahente ay tatanggap ng 40% na komisyon mula lamang sa TUBONG (Interest) nakolekta. Ang puhunan (Principal) at ang natitirang 60% ng tubo ay pag-aari ng Vault.
                  </li>
                  <li className="break-words print:text-black">
                    <strong>Agarang Remittance:</strong> Obligasyon ng Ahente na i-remit ang nakolektang Principal at 60% Vault Interest sa parehong araw ng pangingilekta. Bawal itago, gamitin, o ipahiram ang pera ng Vault.
                  </li>
                  <li className="break-words print:text-black">
                    <strong>Responsibilidad sa Kliyente:</strong> Ang Ahente ang pangunahing tagapaningil ng kanyang mga nirekomendang kliyente. Kung sakaling mag-default ang kliyente, responsibilidad ng Ahente na tumulong sa collection protocol ng Vault.
                  </li>
                  <li className="break-words print:text-black">
                    <strong>Legal na Aksyon (Estafa):</strong> Ang anumang hindi awtorisadong paggamit o pagtatago ng nakolektang pera ng Vault ay ituturing na pagnanakaw at maaaring magresulta sa kasong Estafa.
                  </li>
                </ol>
              </div>
        ...
        {/* ===== PRINT-ONLY: AGENT INFORMATION SUMMARY ===== */}
        <div className="hidden print:block mt-8 text-black">
          ...
          <div className="grid grid-cols-2 gap-y-2 text-sm mb-6">
            <div className="font-semibold">Primary Territory:</div>
            <div>{formData.territory || '—'}</div>
            
            <div className="font-semibold">Network Size:</div>
            <div>{formData.networkSize || '—'}</div>
